        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header ">
                    ...
                    <h3 class="card-title card_title_center">عرض تقارير العملاء </h3>
                </div>
                <!-- /.card-header -->
                <div class="card-body">
                    <div class="row">
                        <input type="hidden" id="ajax_search_url" value="{{ route('report-customerAjax') }}">
                        ...
                        <div class="form-group text-center">
                            ...
                            <a href="{{ route('exportCustomer') }}" class="btn btn-primary btn-sm"> تصدير Exsl </a>
